		...
		<div class="row justify-content-center">			
			<div class="step-2">
				<form action="" id="frm-order">
					<h2 class="fw-800 text-uppercase text-black text-title mb-0 pb-2">Customer’s order review</h2>
			...
			<div class="payment">
				<div class="row g-sm-5 g-4 mt-0">
					<div class="col-lg-7 col-12">
						<div class="border-dashed bg-beige rounded-4 mb-4 payment-method">

...
@section('content')
	<p class="text-primary fs-h5 fw-extrabold">BOOKING ID : F699600811 - FRIENDLY REMINDER ! YOUR PAYMENT IS PENDING !</p>
	<p class="fw-semibold mb-3">Dear <span class="text-primary">Customer’s name,</span></p>
	<p>Thank you for booking with us!<br>We would like to remind you that we have not yet received payment for <b>Booking ID: [F699600811]</b>, which was placed on <b>[Nov 10, 2023]</b>.<br>Please don’t hesitate to contact us by hotline: [+84 987 309 313] or email: [booking@flycorp.vn]. We will be happy to assist you in any way possible. </p>

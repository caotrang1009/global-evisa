		...
		<div class="row">
			<div class="step-part mt-5">
				<div class="d-flex justify-content-between text-title stepper-wrapper">
					...
					<a href="/visa/apply/step2" class="position-relative d-flex flex-column align-items-center cursor-pointer stepper-item completed">
					...
					<a href="/visa/apply/step3" class="position-relative d-flex flex-column align-items-center cursor-pointer stepper-item current">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-12">
				...
				<a href="/visa" class="btn btn-orange btn-lg rounded-4 py-3 px-6 fw-bold text-title fs-6 btn-visa-search">Go to my order</a>
			</div>
			<div class="col-lg-6 col-12">

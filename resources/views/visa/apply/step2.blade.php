	...
	<div class="row g-5">
		<div class="col-lg-8 col-12">
			<div class="border-dashed bg-beige rounded-4 px-lg-6 px-md-5 p-4 mb-4">
				...
				<div class="d-flex justify-content-between mb-5 flex-wrap">
					<label class="payment-method-item mb-4 w-100" for="payment_method_1" data-bs-target="#bank-transfer">
						<div class="d-flex justify-content-center">
							<div>
								<input class="form-check-input fs-5 me-2 mt-0" type="radio" name="payment_method" id="payment_method_1" value="option1">
							</div>
							<div class="rounded-4 p-4 bg-white payment-method-card cursor-pointer">
								<h5 class="fw-bold ms-3 mb-3 text-black method-title">Bank Transfer:</h5>
					...
					<label class="payment-method-item mb-4" for="payment_method_2">
						<div class="d-flex">
							<div>
								<input class="form-check-input fs-5 me-2 mt-0" type="radio" name="payment_method" id="payment_method_2" value="option1">
							</div>
							<div class="rounded-4 p-4 bg-white payment-method-card cursor-pointer">
								<h5 class="fw-bold ms-3 mb-3 text-black method-title">OnePay:</h5>
								<div class="text-center method-icon">
					...
					<label class="payment-method-item mb-4" for="payment_method_3">
						<div class="d-flex">
							<div>
								<input class="form-check-input fs-5 me-2 mt-0" type="radio" name="payment_method" id="payment_method_3" value="option1">
							</div>
							<div class="rounded-4 p-4 bg-white payment-method-card cursor-pointer">
								<h5 class="fw-bold ms-3 mb-3 text-black method-title">PayPal:</h5>
								<div class="text-center method-icon">									
			...
			<div class="border-dashed bg-beige rounded-4 px-lg-6 p-5 mb-4" id="bank-transfer" style="display: none">
		...
		<div class="col-lg-4 col-12">
			<div class="border-dashed bg-beige rounded-4 text-title py-sm-5 p-4 mb-4">
				...
				<a href="{{ url('/visa/apply/step3') }}" class="btn btn-orange btn-lg rounded-4 py-3 fw-bold w-100 btn-visa-search">Confirm your Payment</a>
			</div>
			<div class="secured">

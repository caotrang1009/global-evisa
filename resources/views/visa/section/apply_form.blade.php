<form id="frm-visa-search">
	<div class="row g-4 align-items-end mt-0">
				...
				<div class="col-sm-4">
					<div class="form-group mb-0">
						...
						<div class="dropdown">
							...
							<div class="dropdown-menu rounded-3 p-3 w-100">
								<div class="d-flex align-items-center border rounded-3 px-2">
		...
		<div class="col-lg-4 col-12">
			<a href="{{ url("/visa/information") }}" class="btn btn-orange btn-lg button1 rounded-3 py-3 w-100 btn-visa-search">

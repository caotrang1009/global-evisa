<div class="col-lg-10 step-3">
	<div class="row gx-8">
		<div class="col-lg-7 col-12">
			<h1 class="fw-800 text-uppercase text-black text-title">YOUR ORDER HAS BEEN CONFIRMED!</h1>
		...
		<div class="col-lg-5 col-12">
			<div class="border-dashed bg-beige rounded-4 text-title py-sm-5 p-4 mb-4">
				...
				<a href="{{ url('/visa') }}" class="btn btn-orange btn-lg rounded-4 py-3 fw-bold w-100 btn-visa-search">Back to Home</a>
			</div>
		</div>
	</div>
</div>

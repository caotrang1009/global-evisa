	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-12">
				...
				<h4 class="text-black text-opacity-9">Let us apply the paperworks or eVISA for your trip.</h4>
					...
					<div class="row gx-lg-5 gy-4 mt-0">
						<div class="col-sm-6">
							<div class="form-group mb-0">
								...
								<div class="dropdown">
									<div class="d-flex gap-3 align-items-center justify-content-between border rounded-3 py-1 px-4 input-visa-search" data-bs-toggle="dropdown" data-bs-auto-close="outside">
						...
						<div class="col-12">
							<a href="{{ url("/visa") }}" class="btn btn-primary btn-lg button1 rounded-3 w-100 btn-visa-search">
			...
			<div class="col-lg-6 d-lg-block d-none">
				<div class="position-relative pt-4">
					<div class="graphic-ellipse position-absolute start-10"></div>
					<img class="position-absolute" src="{{ asset('assets/images/banner/home-visa.png') }}" alt="banner" width="450px" height="400px">				
				</div>
			</div>
			<div class="col-12 z-3 mt-lg-7 mt-4">
				<div class="border rounded-3 bg-white px-3 py-4">
				...
				<div class="row justify-content-center mt-4">
					<div class="col-12 text-center">
						<a href="#" class="btn button1 border rounded-3 bg-white w-sm-auto w-100 py-2 px-5">
...
<section>
	<div class="container">
				...
				<div class="card border-0">
					<div class="card-body">
						<div class="d-flex align-items-center gap-4">
							...
							<h4 class="text-uppercase fw-bold mb-0">Support 24/7</h4>
						</div>
						<span class="d-block bg-orange my-3" style="width:64px; height:8px;"></span>
				...
				<div class="card border-0">
					<div class="card-body">
						<div class="d-flex align-items-center gap-4">
							...
							<h4 class="text-uppercase fw-bold mb-0">Fast & Simple</h4>
						</div>
						<span class="d-block bg-orange my-3" style="width:64px; height:8px;"></span>
						<div>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
					</div>
				...
				<div class="card border-0">
					<div class="card-body">
						<div class="d-flex align-items-center gap-4">
							...
							<h4 class="text-uppercase fw-bold mb-0">Approved On Time</h4>
						</div>
						<span class="d-block bg-orange my-3" style="width:64px; height:8px;"></span>
						<div>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
					</div>
				...
				<div class="card border-0">
					<div class="card-body">
						<div class="d-flex align-items-center gap-4">
							...
							<h4 class="text-uppercase fw-bold mb-0">Safe & Private</h4>
						</div>
						<span class="d-block bg-orange my-3" style="width:64px; height:8px;"></span>
						<div>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
					</div>
		...
		<div class="row justify-content-center mt-4">
			<div class="col-12 text-center">
				<a href="{{ url("/visa") }}" class="btn btn-primary btn-lg button1 rounded-3 py-3 px-6 spacing-05 w-sm-auto w-100">
			...
			<div class="col-lg-4 col-md-6 col-12">
				<div class="card h-100 border-0">
					<div class="card-body text-center">
						...
						<div class="text-center medium px-1 pb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
					</div>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 col-12">
...
<section>
	<div class="container">
		<div class="row">
			<h2 class="web-header1 text-uppercase text-decoration-underline text-black text-opacity-9 fw-800 mb-2">TESTIMONIALS</h2>

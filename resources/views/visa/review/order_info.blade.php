<div class="form-group row">
	<div class="col-sm-6">
		...
		<div class="d-flex gap-2 align-items-center justify-content-between border rounded-3 bg-white px-3">
			...
			<input class="form-control border-0 px-0 cursor-pointer" id="destination" name="destination" type="text" value="Lorem Ipsum" placeholder="Please Select" autocomplete="off" readonly>
		</div>
	</div>
	<div class="col-sm-6">
		...
		<div class="d-flex gap-2 align-items-center justify-content-between border rounded-3 bg-white px-3">
			...
			<input class="form-control border-0 px-0 cursor-pointer" type="text" id="type_of_visa" name="type_of_visa" value="Lorem Ipsum" placeholder="Please Select" autocomplete="off" readonly>
		</div>
	</div>
</div>
<div class="form-group row gx-4 gy-3">
	<div class="col-sm-6">
		...
		<div class="d-flex gap-2 align-items-center justify-content-between border rounded-3 bg-white px-3">
			...
			<input class="form-control border-0 px-0 cursor-pointer" type="text" id="day_of_arrival" name="day_of_arrival" value="20/09/2029" placeholder="DD/MM/YY" readonly>
		</div>
	</div>
	<div class="col-sm-6">
		...
		<div class="d-flex gap-2 align-items-center justify-content-between border rounded-3 bg-white px-3">
			<img src="{{ asset('assets/svg/outline/date.svg') }}" data-icon-name="outline/date" alt="date">
			<input class="form-control border-0 px-0 cursor-pointer" type="text" id="day_of_return" name="day_of_return" value="21/10/2029" placeholder="DD/MM/YY" readonly>
		</div>
	</div>
</div>
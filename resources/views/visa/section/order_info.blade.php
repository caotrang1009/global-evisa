<div class="form-group row gx-4 gy-3">
	<div class="col-sm-6">
		...
		<div class="dropdown">
			<div class="d-flex gap-2 align-items-center justify-content-between border rounded-3 bg-white px-3 input-order-info" data-bs-toggle="dropdown" data-bs-auto-close="outside">
				<img class="form-icon" src="{{ asset('assets/svg/outline/map.svg') }}" data-icon-name="outline/map" alt="people">
	...
	<div class="col-sm-6">
		...
		<div class="dropdown">
			<div class="d-flex gap-2 align-items-center justify-content-between border rounded-3 bg-white px-3 input-order-info" data-bs-toggle="dropdown" data-bs-auto-close="outside">
				<img class="form-icon" src="{{ asset('assets/svg/outline/map-gps-navigation.svg') }}" data-icon-name="outline/map-gps-navigation" alt="people">

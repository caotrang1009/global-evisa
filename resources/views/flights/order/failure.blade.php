		...
		<div class="row">
			...
			<div class="step-part mt-4">
				<div class="d-flex justify-content-center text-title stepper-wrapper">
					...
					<a href="{{ url("/flights/review-and-payment") }}" class="position-relative d-flex flex-column align-items-center cursor-pointer stepper-item completed">
				...
				<ul class="mb-4">
					...
					<li>If you still wish to proceed with the payment, please follow the link below to make an online payment:
						<div class="d-flex justify-content-center gap-4 my-4">
							<a href="{{ url("/flights/payment-success/online") }}" class="btn btn-primary rounded-3-5 fw-bold text-title fs-6 py-2 px-5 lh-md">Pay with Paypal </a>
							<a href="{{ url("/flights/payment-success/online") }}" class="btn btn-outline-primary rounded-3-5 fw-bold text-title fs-6 py-2 px-5 lh-md">Pay with OnePay</a>
						</div>
					</li>

	...
	<div class="row justify-content-center px-3 pb-4-5">
		<div class="col-lg-9 col-12">
			<div class="form-group row gx-4">
				<div class="col-sm-6">
					<label class="h6 fw-semibold text-title text-black" for="full_name">Full Name</label>
					<div class="d-flex gap-3 align-items-center justify-content-between border rounded-3-5 bg-white py-1 px-3 input-order-info">
						...
						<input class="form-control border-0 px-0 cursor-pointer" type="text" id="full_name" name="full_name" value="Lorem Ipsum" placeholder="Enter Value" >
					</div>
				</div>
				<div class="col-sm-6">
			...
			<div class="form-group row g-4">
				...
				<div class="col-sm-6">
					...
					<div class="d-flex gap-3 align-items-center justify-content-between border rounded-3-5 bg-white py-1 px-3 input-order-info">
						...
						<input class="form-control border-0 px-0 cursor-pointer" type="text" id="appointment_location" name="appointment_location" value="Los Angeles" placeholder="Please Select" >
					</div>
				</div>
			</div>
			<div class="form-group row g-4">
			...
			<div class="form-group row g-4 mb-0">
				<div class="col-sm-6">
					<label class="h6 fw-semibold text-title text-black" for="photo_of_passport">Photo of Passport Page</label>
					<div class="border rounded-3-5 bg-secondary bg-opacity-75 text-center align-middle cursor-pointer">
						<img class="fit-cover rounded-3-5" src="{{ asset('assets/images/passport.png') }}" alt="" height="160px" width="100%">
					</div>
				</div>
				<div class="col-sm-6">
					<label class="h6 fw-semibold text-title text-black" for="portrait_photo">Portrait Photo</label>
					<div class="border rounded-3-5 bg-secondary bg-opacity-75 text-center align-middle cursor-pointer">
						<img class="fit-cover rounded-3-5" src="{{ asset('assets/images/portrait.png') }}" alt="" height="160px" width="100%">
					</div>
				</div>
			</div>
		</div>
